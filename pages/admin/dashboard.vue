						...
						<div class="row">
							<div class="col-md-4 col-xl-3">
								<div class="card bg-c-blue order-card">
									<nuxt-link :to="`/admin/institute`">
										<div class="card-block">
											<h6 class="m-b-20">Total Institute</h6>
											<h2 class="text-right">
												<span>{{ institutecount }}</span>
											</h2>
											<!--
										<p class="m-b-0">
											Completed Orders
...
export default Vue.extend({
	...
	methods: {
		async getAdminDashboardIndex() {
			try {
				const res = await this.$axios.get(`/admin/admin-dashboard`);
				...
				this.institutecount = res.data.institutecount ?? '';
