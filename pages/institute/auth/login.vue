				...
				<section class="row justify-content-center align-items-center mt-md-5">
					<div class="col-12 col-md-6 col-xl-7 px-4">
						...
						<div class="d-block d-md-none">
							<div class="mt-5">
								<h3 class="font-weight-bold">Hello institute!</h3>
					...
					<div class="col-12 col-md-6 col-xl-5">
						<form @submit.prevent="postinstituteLogin()">
							<div class="mx-4">
								<div class="form-row">
...
export default Vue.extend({
	...
	layout: 'empty',
	head: {
		title: 'institute Login With Email',
		bodyAttrs: {
			id: 'institute-login-with-email',
		},
	},
	...
	created() {
		this.$auth.setStrategy('institute');
		this.$auth.options.redirect.home = '/institute/dashboard';
		this.$auth.options.redirect.logout = '/institute/auth/login';
	},
});
</script>
